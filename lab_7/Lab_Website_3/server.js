...
app.get('/player_info/post', function(req, res) {
  ...
  var lis = 'select id,name from football_players;';
  
  //var playerInfo1 = 'select * from football_players where id = 3';
  var playerInfo = "select * from football_players where id = '" +player_id +"';";


  var gameCount = "select count(*) from football_games where '"+player_id+ "'= any(players);";
  db.task('get-everything' , task => {
    return task.batch([
      task.any(lis),
      task.any(playerInfo),
